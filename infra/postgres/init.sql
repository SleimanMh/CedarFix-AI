...
-- =============================================================================
-- Offline GPT-4o LLM-as-Judge Evaluations
-- This table is written only by the monitoring service. It is intentionally
-- isolated from the live complaint pipeline and must never influence pipeline
-- decisions.
-- =============================================================================
