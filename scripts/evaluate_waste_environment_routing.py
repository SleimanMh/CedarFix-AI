#!/usr/bin/env python3
"""Evaluate waste/environment routing guardrails."""
...
EVAL = ROOT / "data" / "eval" / "waste_environment_routing_eval_v1.jsonl"
...
def main() -> int:
    ...
    print(f"Waste/environment routing eval: {len(cases) - len(failures)}/{len(cases)} passed")
    if failures:
        print("Failures:")
