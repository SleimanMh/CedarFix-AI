#!/usr/bin/env python3
"""Validate electricity knowledge-base shard."""
...
def main() -> int:
    ...
    if not ELECTRICITY.exists():
        errors.append(f"missing folder: {ELECTRICITY}")
    else:
    ...
    print("Electricity KB validation:")
    ...
    print("OK [electricity_kb]: passed")
    return 0
