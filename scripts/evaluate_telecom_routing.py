#!/usr/bin/env python3
"""Evaluate telecom routing guardrails."""
...
EVAL = ROOT / "data" / "eval" / "telecom_routing_eval_v1.jsonl"
...
def main() -> int:
    ...
    for case in cases:
        ...
        checks = {
            ...
            "primary": result.primary_entity == case["expected_primary_entity"],
    ...
    print(f"Telecom routing eval: {len(cases) - len(failures)}/{len(cases)} passed")
    if failures:
        print("Failures:")
