#!/usr/bin/env python3
"""Evaluate public-safety/enforcement routing guardrails."""
...
EVAL = ROOT / "data" / "eval" / "public_safety_enforcement_routing_eval_v1.jsonl"
...
def main() -> int:
    ...
    print(f"Public safety/enforcement routing eval: {len(cases) - len(failures)}/{len(cases)} passed")
    if failures:
        print("Failures:")
