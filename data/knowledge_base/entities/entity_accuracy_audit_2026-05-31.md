...
- Registered source IDs: 139
- `source_registered`: 18
- Registry warning: exact duplicate source IDs de-duplicated across registries: 85
...
| ISF | source_registered | 8 | - | - | official_email |
...
| SLWE | source_registered | 6 | - | - | hq_address, ticket_reference_policy |
| TRA | source_registered | 6 | - | - | ticket_reference_policy |
