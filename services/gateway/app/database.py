...
async def save_complaint(decision: ComplaintDecision):
    ...
    async with AsyncSessionLocal() as session:
        record = Complaint(
            ...
            detected_language=decision.text_analysis.detected_language if decision.text_analysis else None,
            complaint_type=decision.complaint_type,
            complaint_type_confidence=decision.text_analysis.complaint_type_confidence if decision.text_analysis else None,
